...
urlpatterns = [
    ...
    path('delivery_city_choice/<int:product_id>/', views.delivery_city_choice, name='delivery_city_choice'),
    path('get_sdek_delivery_cost/<int:product_id>/', views.get_sdek_delivery_cost, name='get_sdek_delivery_cost'),
