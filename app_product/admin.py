...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'name', 'category', 'article', 'wb_true', 'ozon_true', 'update_true', 'image_1', 'image_2', 'image_3', 'ozon_id', 'ozon_sku', 'wb_id', 'wb_bar_code', 'length', 'width', 'height', 'quantity', 'av_price', 'total_sum', )
    search_fields = ('article', 'ozon_id', 'ozon_sku', 'wb_id', 'wb_bar_code' )
    list_editable = ('category', 'length', 'width', 'height', 'image_1', 'image_2', 'image_3', 'update_true', 'wb_true', 'ozon_true', 'quantity', 'total_sum',)
    list_per_page=25
