...
urlpatterns = [
    ...
    path('inventory_manual', views.inventory_manual, name='inventory_manual'),
    path('update_ozon_prices', views.update_ozon_prices, name='update_ozon_prices'),
    path('update_ozon_images', views.update_ozon_images, name='update_ozon_images'),
